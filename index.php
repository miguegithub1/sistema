						...
						<div class="col-sm-12 border border-primary shadow rounded bg-white pt-2">
							...
							<form method="post" id="singninFrom" onSubmit="return false;">
								<div class="form-group">
									<label class="font-weight-bold">Email <span class="badge badge-secondary"> O </span> Num. Empleado <span class="text-danger">*</span></label>
									<input type="text" name="signinname" id="signinname" class="form-control form-control-lg" autocomplete="off" placeholder="Email o Num. Empleado" data-required>
								</div>
								<div class="form-group">
						...
						<div class="col-sm-12 border border-primary shadow rounded bg-white pt-1">
							...
							<form method="post" id="singnupFrom" onSubmit="return false;">
								...
								<div class="form-group">
									...
									<input type="text" name="signupusermatricula" id="signupusermatricula"  placeholder="Matricula" data-required>
								</div>
								<div class="form-group">
					...
					<form method="post" id="forgotpassForm" onSubmit="return false;">
						<div class="modal-content">
							...
							<div class="modal-body"> <em id="forgotPassMsg"></em>
								<div class="form-group">
									<label class="font-weight-bold">Email <span class="badge badge-secondary">OR</span> numero_empleado <span class="text-danger">*</span></label>
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-fw fa-long-arrow-alt-left"></i> Iniciar Sesion</button>
